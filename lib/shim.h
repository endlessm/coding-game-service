...
G_DECLARE_FINAL_TYPE (CodingGameServiceAppIntegrationController,
                      ...
                      CodingGameServiceCodingGameServiceProxy)

CodingGameServiceAppIntegrationController *coding_game_service_app_integration_controller_new ();

typedef void (*CodingGameServiceAppIntegrationControllerInterestCallback)(CodingGameServiceAppIntegrationController *, gpointer user_data);
 ...
 * event name.
 *
 * @param controller: A #CodingGameServiceAppIntegrationController
 * @param event_name: The event name to respond to
 * @param register_interest_cb: Callback to call when we the game service
 *                              is interested in an event. Set up any
 *                              event handlers internally here.
 * @param register_user_data: User data to provide to register_interest_cb
 * @param destroy_register_data: A #GDestroyNotify for register_user_data
 * @param deregister_interest_cb: Callback to call when we the game service
 *                                is not longer interested in an event.
 *                                Remove any event handlers internally here.
 * @param deregister_user_data: User data to provide to deregister_interest_cb
 * @param destroy_deregister_data: A #GDestroyNotify for deregister_user_data
 */
void
 ...
 *
 * @param controller: A #CodingGameServiceAppIntegrationController
 * @param event_name: The event name that ocurred.
 */
void
